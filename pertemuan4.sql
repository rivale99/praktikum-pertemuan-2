...
-- Dumping data for table presensi_penggajian.bagian: ~3 rows (approximately)
...
-- Dumping data for table presensi_penggajian.bagian_karyawan: ~6 rows (approximately)
...
-- Dumping data for table presensi_penggajian.jabatan: ~5 rows (approximately)
...
-- Dumping data for table presensi_penggajian.jabatan_karyawan: ~17 rows (approximately)
...
-- Dumping data for table presensi_penggajian.karyawan: ~8 rows (approximately)
...
-- Dumping data for table presensi_penggajian.lokasi: ~3 rows (approximately)
/*!40000 ALTER TABLE `lokasi` DISABLE KEYS */;
REPLACE INTO `lokasi` (`id`, `nama_lokasi`, `alamat_gedung`) VALUES
	(1, 'Kota Banjarmasin', ''),
	(2, 'Kota Banjarbaru', ''),
	(3, 'Kabupaten Banjar', '');
/*!40000 ALTER TABLE `lokasi` ENABLE KEYS */;

-- Dumping data for table presensi_penggajian.penggajian: ~18 rows (approximately)
...
-- Dumping data for table presensi_penggajian.pengguna: ~8 rows (approximately)
...
-- Dumping data for table presensi_penggajian.presensi: ~552 rows (approximately)
